# extracted from gate8c1/sources.py -- imports rewritten, logic unchanged.
...
from core.datasets.kitti360_folds import G8B_ROOT, K360_TRAIN_DRIVES, K360_VAL_DRIVE
from core.datasets import kitti360_transforms as TF
