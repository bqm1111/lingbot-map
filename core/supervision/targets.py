# extracted from gate8/targets.py -- imports rewritten, logic unchanged.
...
from core.evaluation import official_targets as G6T
from core.datasets import sources as S, union_vocab as V8
from core.mapping.feed import CachedFeed
from core.mapping.mapper import IncrementalMapper
