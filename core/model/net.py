# extracted from gate8/net.py -- imports rewritten, logic unchanged.
...
from core.datasets import union_vocab as V8
from core.supervision.targets import N_INPUT_CHANNELS
