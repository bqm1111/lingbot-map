# extracted from gate6/targets.py -- imports rewritten, logic unchanged.
...
from core.datasets.occ_datasets import load_semantickitti_target
from core.datasets.occupancy import SEMANTICKITTI_GRID
from core.datasets.occ3d_grid import NATIVE as OCC3D_NATIVE
from core.datasets.kitti360 import SSCBENCH_KITTI360_GRID, load_target as k360_target
from core.datasets.kitti360 import SEQUENCE as KITTI360_SEQUENCE_DEFAULT
