#!/usr/bin/env python
"""Gate 8D: train one seed on KITTI-360 alone, behind a runtime dataset firewall.
...
from gates.gate8d.net import SurfaceCompletionUNet, save_checkpoint                            # noqa: E402
from gates.gate8d import sources as SRC                                               # noqa: E402
from gates.gate8d.data import DriveSamples                                            # noqa: E402
from sscbench_kitti360.audit import FileAudit                                    # noqa: E402
from tools.gate8d.losses import step_loss                                         # noqa: E402
...
def run(cfg, device, steps=None):
    ...
    net = SurfaceCompletionUNet(width=cfg["width"],
                                padding_mode=cfg.get("padding_mode", "replicate")).to(dev)
